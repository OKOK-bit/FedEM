...
class GradientReconstructor():
    ...
    def reconstruct(self, input_data, labels, img_shape=(3, 32, 32), dryrun=False, eval=True, tol=None, tb_writer=None,
                    cid=0, bid=0):
        ...
        try:
            for trial in range(self.config['restarts']):
                x_trial, labels = self._run_trial(x[trial], input_data, labels, dryrun=dryrun, tb_writer=tb_writer,
                                                  cid=cid, bid=bid)
                # Finalize
